...
To contributem follow the steps below

1. Fork the project
1. Create a branch for your new piece of work or change.
1. Make your changes, follow the styleguide and write good commit messages.
...
1. Name you files appropriately.
1. Use headings for easier navigation using the *table of contents* on the right.
