...
<details>
  ...
  <iframe src="https://www.moodle.aau.dk/pluginfile.php/1570708/mod_resource/content/10/Lecture-2.pdf" width="100%" height="500px"></iframe>
</details>
...
### Insertion Sort
![Insertion Sort](analyzing-algorithms-insertion-sort.png)
...
![Analysis of Insertion Sort](analyzing-algorithms-analysis-insertion-sort.png)
![Analysis of Insertion Sort](analyzing-algorithms-analysis-insertion-sort-2.png)
...
![Analysis of Insertion Sort](analyzing-algorithms-theta-notation.png)

##### Proof
![Analysis of Insertion Sort](analyzing-algorithms-proof-engineering-way.png)

#### Big-O Notation $\mathcal{O}$
![Analysis of Insertion Sort](analyzing-algorithms-big-o-notation.png)

#### Big-Omega notation $\Omega$
![Analysis of Insertion Sort](analyzing-algorithms-big-omega-notation.png)
...
![Analysis of Insertion Sort](analyzing-algorithms-exercise-3-1-1.png)
...
![Exercises](analyzing-algorithms-exercise-2.png)

### Extra questions

Solve questions in this [file](https://www.moodle.aau.dk/pluginfile.php/373593/mod_resource/content/1/exercises2.pdf)
...
![Exercises](analyzing-algorithms-exercise-2-1.png)
