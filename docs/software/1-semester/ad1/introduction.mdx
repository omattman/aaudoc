...
<details>
  ...
  <iframe src="https://www.moodle.aau.dk/pluginfile.php/1570716/mod_resource/content/13/Lecture-1.pdf" width="100%" height="500px"></iframe>
</details>
...
is **Analysis** and **Design**. We will not work with the *implementation*.
...
![Data structures vs. algorithms](data-structures-vs-algorithms.png)
