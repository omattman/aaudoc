# Lecture 1: Introduction and System Choice
...
## Group Exercises
1. Test
2. **Select an existing system, which you know well. Describe the problem domain, application domain,
model, function, and interfaces for this system.**
