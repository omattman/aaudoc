...
<Note>
  ...
  <br /><br />
  <strong>Open architecture:</strong> A given layer can use operations from any layer abve or below.
  <br /><br />
...
#### Section 9, exercise 2 (page 188)
> Why is it important to set design criteria for each project?

#### Section 9, exercise 5 (page 188)
> What are criteria used for in a systems development project?

#### Section 10, exercise 3 (page 209)
> Why should the architecture reflect stable structures in the context?

#### Section 10, exercise 5 (page 209)
> What are the characteristic features of the client-server architecture pattern?
