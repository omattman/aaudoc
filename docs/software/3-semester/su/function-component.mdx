...
> __Definition__: Operation: A Process property specified in a class and activated
> through the class' object.

![Specification of the function component result](images/function-component-specification.png)

### Responsibility
__Component__: A collection of program parts that constitutes a whole and has well-defined
responsibilities.

__Responsibility of the function component__: Make the model component available as a resource to actors.
...
__NOTE__: For this exercise we will look at the Butlr project instead.
