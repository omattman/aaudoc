...
export const globalStyles = t => {
  return {
    ...
    blockquote: {
      ...
      marginLeft: 0,
      marginRight: 0,
      background: t.colors.question.background,
      borderLeftColor: t.colors.question.border,
      padding: "12px 24px 12px 30px",
      margin: "2em 0",
      borderLeftWidth: "4px",
      borderLeftStyle: "solid",
      backgroundColor: t.colors.question.background,
      position: "relative",
      ...
      "&:before": {
        ...
        top: "14px",
        left: "-12px",
        backgroundColor: t.colors.question.border,
        color: t.colors.grey[80],
        width: "20px",
        height: "20px",
        borderRadius: "100%",
        textAlign: "center",
